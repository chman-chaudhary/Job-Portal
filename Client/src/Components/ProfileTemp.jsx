  ...
  return (
    <div className=" text-white custom-fonts">
        ...
        <div className="flex justify-between">
          ...
          {isOwner && (
            <Link
              ...
              className="hover:opacity-50 duration-200 ease-in px-8"
            >
            ...
            <ul className="flex gap-x-12 justify-end">
              {userData.twitter && (
                <li className="mb-4">
                  ...
                  >
                    <i className="fa-brands fa-x-twitter text-3xl hover:-translate-y-1 duration-200 ease-in"></i>
                  </a>
                </li>
              )}
              {userData.github && (
                <li className="mb-4">
                  <a
                    ...
                    className="hover:opacity-50 duration-200 ease-in"
                  >
                    <i className="fa-brands fa-github text-3xl hover:-translate-y-1 duration-200 ease-in"></i>
                  </a>
                </li>
              )}
              {userData.linkedIn && (
                <li className="mb-4">
                  <a
                    ...
                    className="hover:opacity-50 duration-200 ease-in"
                  >
                    <i className="fa-brands fa-linkedin-in text-3xl hover:-translate-y-1 duration-200 ease-in"></i>
                  </a>
                </li>
              )}
              {userData.portfolio && (
                <li className="mb-4">
                  <a
                    ...
                    className="hover:opacity-50 duration-200 ease-in"
                  >
                    <i className="fa-solid fa-globe text-3xl hover:-translate-y-1 duration-200 ease-in"></i>
                  </a>
                </li>
              )}
            </ul>
      ...
      <div className="mx-16 mt-6 py-2 mb-6">
        ...
        <pre
          className="text-xl custom-fonts leading-loose"
