...
function SignupForm() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-20 text-white mx-6 custom-fonts text-center">
            ...
            <div>
              ...
              <input
                {...register("username", {
                  ...
                  maxLength: {
                    value: 18,
                    message: "username should contain atmost 18 characters.",
                  },
                })}
                id="username"
            ...
            <div>
              ...
              <input
                {...register("password", {
                  ...
                  maxLength: {
                    value: 18,
                    message: "Password should contain atmost 18 characters.",
                  },
                })}
                id="password"
                type="Password"
