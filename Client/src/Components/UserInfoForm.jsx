...
export default function UserInfoForm() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            let response = await axios.post("https://job-portal-server-91sy.onrender.com/profile/new", formData, {
                headers: {
        ...
        <>
            ...
            <div className='pt-[92px] text-white mx-6 custom-fonts text-center'>
                ...
                <h3 className="text-xl mt-8">
                    Explore Opportunities with MarsX
                </h3>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <div className="flex space-x-5">
                            <div className="w-full">
                                ...
                                />
                                {errors.firstname && <div className='text-rose-600 text-lg -mt-3 mb-1 text-center'>{errors.username.message}</div>}
                            </div>
                            <div className="w-full">
                        ...
                        <div>
                            ...
                            <div className='space-x-5 flex items-center mt-4 mb-8 px-3'>
                                <div className="shrink-0">
                                    <img className="h-32 w-32 object-cover rounded-full" name="currImg" src={"https://pluspng.com/img-png/user-png-icon-download-icons-logos-emojis-users-2240.png"} alt="Current profile photo" />
                                </div>
                                <label className="block">
                                    <span className="sr-only">Choose profile photo</span>
                                    <input type="file" className="block w-full text-sm text-slate-300
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="border-[1px] w-full border-[#4C4C4C] h-20 bg-black p-5 text-lg rounded-full w-5/5 mr-10 mt-2 mb-4 hover:scale-105 hover:border-white duration-300 ease-linear"
                            />
                            {errors.country && <div className='text-rose-600 text-lg -mt-3 mb-1 text-center'>{errors.username.message}</div>}
                        </div>
                        ...
                        <div className="flex space-x-5">
                            <div className="w-full">
                                ...
                                <input
                                    ...
                                    className="border-[1px] w-full border-[#4C4C4C] bg-black p-5 h-20 text-lg rounded-full w-5/5 mr-10 mt-2 mb-4 hover:scale-105 hover:border-white duration-300 ease-linear"
                                />
                                {errors.city && <div className='text-rose-600 text-lg -mt-3 mb-1 text-center'>{errors.username.message}</div>}
                            </div>
                            <div className="w-full">
                                ...
                                <br />
                                <input
                                    {...register("region", { required: { value: true, message: "State / Province is required" } })}
                                    type="text"
                                    placeholder='Haryana'
                                    id="region"
                                    className="border-[1px] border-[#4C4C4C] bg-black p-5 h-20 text-lg rounded-full w-5/5 w-full mr-10 mt-2 mb-4 hover:scale-105 hover:border-white duration-300 ease-linear"
                                />
                                {errors.region && <div className='text-rose-600 text-lg -mt-3 mb-1 text-center'>{errors.username.message}</div>}
                                <br />
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex items-center justify-end gap-x-6">
                            <button type="button" className="text-sm font-semibold leading-6 text-[#F6F6F6]">Cancel</button>
                            <button type="submit" disabled={isSubmitting} className="rounded-md bg-[#353DFF] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                        </div>
                    </form>
                    <ToastContainer />
                </div>
